...
const FormComponent = ({ selectedOption, setSelectedOption }) => {
            ...
            {!selectedOption || selectedOption === 'text' ? (
                ...
                <>
                    {formInputs.map((input, index) => (
                        ...
                        >
                            <Col className="col-1">
                                <Input type={selectedOption} disabled hidden={selectedOption === 'text'} />
                            </Col>
                            <Col className="col-8">
                            ...
                            <Col>
                                <Button className='delete-input-button' style={{ height: "25px", width: '30%', display: "flex", justifyContent: "center", alignItems: "center" }} onClick={() => handleRemoveInput(input.key)}>X</Button>
                            </Col>
                        </Row>
                    ))}
                    <Row>
